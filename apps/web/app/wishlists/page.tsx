...
import { wishlistService } from '../../services/data-service';
import { transformWishlistForGrid } from '../../utils/formatters';
import { Button } from '@repo/ui/components/button';
import { List, Plus } from 'lucide-react';
import type { Wishlist } from '../../types';

function WishlistsContent() {
  const { data: wishlists, refetch } = useDataFetching<Wishlist[]>({
